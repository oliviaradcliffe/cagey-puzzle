...
def test_mrv():
    ...
    var1 = []
    var1 = ord_mrv(simpleCSP)

    #print("simpleCSP.vars[0].name: ",simpleCSP.vars[0].name)
    #print("simpleCSP.vars: ",simpleCSP.vars)
    ...
    if var1:
        if((var1.name) == simpleCSP.vars[0].name):
            score += 1
    ...
    if var2:
        if((var2.name) == simpleCSP.vars[len(simpleCSP.vars)-1].name):
            score += 1
